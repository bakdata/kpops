...
def test_should_set_pipeline_name_with_default_base_dir():
    PipelineParser.set_pipeline_name_env_vars(DEFAULT_BASE_DIR, PIPELINE_PATH)
...
def test_should_set_pipeline_name_with_specific_relative_base_dir():
    PipelineParser.set_pipeline_name_env_vars(Path("./some/random/path"), PIPELINE_PATH)
...
def test_should_set_pipeline_name_with_absolute_base_dir():
    PipelineParser.set_pipeline_name_env_vars(Path.cwd(), PIPELINE_PATH)
...
def test_should_not_set_pipeline_name_with_the_same_base_dir():
    with pytest.raises(
        ...
        PipelineParser.set_pipeline_name_env_vars(PIPELINE_PATH, PIPELINE_PATH)
...
def test_pipeline_file_name_environment():
    ...
    environment = PipelineParser.pipeline_filename_environment(PIPELINE_PATH, config)
