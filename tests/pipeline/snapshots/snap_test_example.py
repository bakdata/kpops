    ...
    "components": [
        {
            "app": {
                ...
                "streams": {
                    ...
                    "schemaRegistryUrl": "http://k8kafka-cp-schema-registry.kpops.svc.cluster.loc",
                },
                "suspend": True,
            },
        ...
        },
        {
            "app": {
                ...
                "streams": {
                    "brokers": "http://k8kafka-cp-kafka-headless.kpops.svc.cluster.local:9092",
                    "errorTopic": "bakdata-atm-fraud-detection-transaction-joiner-dead-letter-top",
                    "inputTopics": [
                        "bakdata-atm-fraud-detection-transaction-avro-producer-topic"
                    ],
        ...
        },
        {
            "app": {
                ...
                "connection.url": "jdbc:postgresql://postgresql-dev.kpops.svc.cluster.local:543",
                ...
                "value.converter.schema.registry.url": "http://k8kafka-cp-schema-registry.kpops",
            },
            "name": "postgresql-connector",
            "namespace": "${NAMESPACE}",
            "repoConfig": {
