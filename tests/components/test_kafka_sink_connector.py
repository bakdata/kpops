    ...
    def test_connector_instantiation(
        ...
        component_data = {
            "_resetter": {
                "app": {
                    "config": {
                        ...
                        "connector": "resources-resetter_values-inflated-connector-name",
                        "deleteConsumerGroup": None,
                        "offsetTopic": None,
                    },
                    "connectorType": "sink",
                    "label": "inflated-connector-name",
                    "nameOverride": None,
                    "streams": {
                        "brokers": "http://k8kafka-cp-kafka-headless.kpops.svc.cluster.local:9092"
                    },
                ...
                "namespace": "namespace",
                "prefix": "resources-resetter_values-",
                "repo_config": {
                    "repo_auth_flags": {
                        "ca_file": None,
                        "cert_file": None,
            ...
            "app": {
                ...
                "name": "resources-resetter_values-inflated-connector-name",
            },
            "from": None,
            "name": "inflated-connector-name",
            "prefix": "resources-resetter_values-",
            "resetter_namespace": None,
            "resetter_values": {"nameOverride": None},
            "to": None,
